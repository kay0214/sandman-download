...
@MapperScan(basePackages = "com.sandman.film.dao.mysql.system", sqlSessionFactoryRef = "mysqlSqlSessionSystemFactory")
public class MysqlDataDaoSystemConfig {
    ...
    public SqlSessionFactory mysqlSqlSessionSystemFactory() throws Exception {
        ...
        factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:com/sandman/film/dao/mysql/system/mapper/xml/**/*.xml"));
