 ...
 */
package com.sandman.film.crawler.bean;

import com.sandman.film.crawler.utils.DyttInsertData;
...
public class Link {
    ...
    public static void putFilmTypes(List<FilmType> filmTypes){
        for(FilmType filmType:filmTypes){
            Link.filmTypes.put(filmType.getName(),filmType.getId());
        }
    }
