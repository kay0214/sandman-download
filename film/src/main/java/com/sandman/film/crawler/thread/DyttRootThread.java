 ...
 */
package com.sandman.film.crawler.thread;
...
import com.sandman.film.utils.CrawlerDateUtils;
import com.sandman.film.utils.WebClientUtils;
                ...
                for(DomElement table:tables){
                    if(table.hasAttribute("class") && "tbspan".equals(table.getAttribute("class"))){
                        ...
                        if(StringUtils.isNotBlank(date)){
                            Date pageDate = CrawlerDateUtils.formatDate(date);
                            if(pageDate!=null && (CrawlerDateUtils.before(pageDate,Link.deadLine) || Link.deadLine == null)){
